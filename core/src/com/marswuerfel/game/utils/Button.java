...
public class Button extends Sprite {
	 ...
	 * 
	 * @param texturePath
	 *            - Path to the Image that represents the Button
	 * @param x
	 *            - x-coordianate on which the Button should be placed.
	 * @param y
	 *            - y-coordianate on which the button should be placed ( [0,0]
	 *            is on the bottom left cornor ).
	 * @param width
	 *            - width of the Button.
	 * @param height
	 *            - height of the Button.
	 * @return A Button Object based on the {@link Texture} which is created by
	 *         the texturePath.
	 */
	public Button(String texturePath, float x, float y, float width,
			float height) {
